...
import com.teamsync.feedmanagement.service.CommentService;
...
public class CommentController {
        ...
        public ResponseEntity<SuccessResponse<List<CommentResponseDTO>>> getAllComments(
        ...
        public ResponseEntity<SuccessResponse<CommentResponseDTO>> updateComment(
                        @PathVariable("id") Long postId,
                        @PathVariable("commentId") Long commentId,
                        @Valid @RequestBody CommentUpdateRequestDTO requestDTO) {
                CommentResponseDTO comment = commentService.updateComment(postId, commentId, requestDTO);
                return ResponseEntity.ok(
                                SuccessResponse.<CommentResponseDTO>builder()
                                                .code(HttpStatus.OK.value())
                                                .status(HttpStatus.OK)
        ...
        public ResponseEntity<SuccessResponse<ReactionResponseDTO>> addCommentReaction(
                        @PathVariable("postId") Long postId,
                        @PathVariable("commentId") Long commentId,
                        @Valid @RequestBody ReactionCreateRequestDTO requestDTO) {
                ReactionResponseDTO reaction = commentService.addReactionToComment(postId, commentId, requestDTO);
                return ResponseEntity.status(HttpStatus.CREATED).body(
                                SuccessResponse.<ReactionResponseDTO>builder()
                                                .code(HttpStatus.CREATED.value())
                                                .status(HttpStatus.CREATED)
        ...
        public ResponseEntity<SuccessResponse<CommentResponseDTO>> addReplyToComment(
                        @PathVariable("id") Long postId,
                        @PathVariable("commentId") Long commentId,
